...
def governance_schema() -> dict[str, object]:
    return {
        ...
        "$defs": {
            ...
            "bundle_governance_projection": {
                "description": "Optional, rebuildable Bundle v2 projection; the registry remains authoritative.",
                "type": "object",
                "required": [
                    "contract",
                    "vault_id",
                ...
                "properties": {
                    "contract": {"const": "hermes-governance/v1"},
                    "vault_id": {"$ref": "#/$defs/stable_id"},
